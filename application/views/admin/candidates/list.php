              ...
              <div class="col-md-12">
                <div class="datatable-top-controls datatable-top-controls-filter">
                  <?php if (allowedTo('add_candidate')) { ?>
                    ...
                    <?php echo lang('add_candidate_by_resume'); ?>
                    Add by ressume
                    </button>

                    <!-- Modal -->
                    <?php echo form_open_multipart(base_url()."admin/candidates/addCandidateByResume");?>
                    <div class="modal fade" action="" id="exampleModal" tabindex="-1" method="post" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
