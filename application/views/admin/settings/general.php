              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?php $file = setting('site-logo') != '' ? base_url().'assets/front/images/'.setting('site-logo') : ''; ?>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?php $file = setting('site-banner-image') != '' ? base_url().'assets/front/images/'.setting('site-banner-image') : ''; ?>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?php $file = setting('site-favicon') != '' ? base_url().'assets/front/images/'.setting('site-favicon') : ''; ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <br />
                    <input type="radio" class="minimal" name="enable-email-verification" value="yes" <?php sel(setting('enable-email-verification'), 'yes', 'checked'); ?>> 5
                    <input type="radio" class="minimal" name="enable-email-verification" value="no" <?php sel(setting('enable-email-verification'), 'no', 'checked'); ?>> 10
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <br />
                    <input type="radio" class="minimal" name="enable-forgot-password" value="yes" <?php sel(setting('enable-forgot-password'), 'yes', 'checked'); ?>> 5
                    <input type="radio" class="minimal" name="enable-forgot-password" value="no" <?php sel(setting('enable-forgot-password'), 'no', 'checked'); ?>> 10
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <br />
                    <input type="radio" class="minimal" name="enable-register" value="yes" <?php sel(setting('enable-register'), 'yes', 'checked'); ?>> 5
                    <input type="radio" class="minimal" name="enable-register" value="no" <?php sel(setting('enable-register'), 'no', 'checked'); ?>> 10
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
