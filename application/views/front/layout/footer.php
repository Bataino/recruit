  ...
  <script src="<?php echo base_url(); ?>assets/front/js/bootstrap-select.min.js"></script>

  <!-- JS Language Variables file -->
  <script src="<?php echo base_url(); ?>assets/front/js/lang.js?ver=<?php echo strtotime(date('Y-m-d G:i:s')); ?>"></script>
